...
const CHAOS_OPTIONS: ChaosOption[] = [
  {
    type: 'openai_outage',
    label: '01. LLM Blackout',
    category: 'provider',
    severity: 'critical',
    description: 'Brings OpenAI API Gateway offline, returning HTTP 503 errors.',
  },
  {
    type: 'retry_storm',
    label: '02. Retry Storm',
    category: 'orchestration',
    severity: 'high',
    description: 'Triggers aggressive agent retry loops, overloading message queues.',
  },
  {
    type: 'vector_db_corruption',
    label: '03. Vector DB Corruption',
    category: 'infrastructure',
    severity: 'critical',
    description: 'Corrupts vector index query partitions, causing search timeouts.',
  },
  {
    type: 'mcp_server_crash',
    label: '04. MCP Tool Crash',
    category: 'infrastructure',
    severity: 'high',
    description: 'Crashes MCP executor process, preventing tool executions.',
  },
  {
    type: 'memory_overflow',
    label: '05. Gateway Memory Leak',
    category: 'orchestration',
    severity: 'high',
    description: 'Gateway buffer heap overflows, causing severe GC pauses.',
  },
  {
    type: 'queue_congestion',
    label: '06. Queue Saturation',
    category: 'orchestration',
    severity: 'medium',
  ...
  },
  {
    ...
    label: '07. Regional Outage',
    category: 'provider',
    severity: 'critical',
    description: 'AWS US-East-1 region blackouts due to BGP link failure.',
  },
  {
    type: 'token_flood',
    label: '08. Token Flood Attack',
    category: 'provider',
    severity: 'high',
    description: 'Floods LLM gateway with prompt payloads exceeding 300k tokens.',
  },
  {
    type: 'agent_deadlock',
    label: '09. Agent Deadlock',
    category: 'orchestration',
    severity: 'high',
    description: 'Locks agent swarm loops in circular dependency structures.',
  },
  {
    type: 'latency_cascade',
    label: '10. Latency Cascade',
    category: 'infrastructure',
    severity: 'medium',
    description: 'Downstream DB locks propagate delays upstream to API Gateway.',
  },
];
